...
class TrainLoop:
    ...
    def run_loop(self):
        # note: the start of the training
        i = 0
        ...
        while (
            ...
            try:
                    ...
                    data_iter = iter(self.dataloader)
                    # note: here get the data
                    batch, cond, name = next(data_iter)

            # note: here to run step
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            # note: here to training_losses_segmentation
